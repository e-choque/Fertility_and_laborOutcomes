...
reg more2sons samesex edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year, r 
...
*ivregress gmm tothrs edad edad_fb hijo1_sexa region pareja granfb etnia_b  i.year  (more2sons = samesex) , vce(robust)
...
outreg2 using regression_result, replace excel dec(0)
qreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year [pw=wstar_y1], quant(.5)
outreg2 using regression_result, append excel dec(0)
qreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b  i.year [pw=wstar_y1], quant(.6)
outreg2 using regression_result, append excel dec(0)
qreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year [pw=wstar_y1], quant(.7)
outreg2 using regression_result, append excel dec(0)
qreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year [pw=wstar_y1], quant(.75)
outreg2 using regression_result, append excel dec(0)
qreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year [pw=wstar_y1], quant(.8)
outreg2 using regression_result, append excel dec(0)
qreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year [pw=wstar_y1], quant(.9)
outreg2 using regression_result, append excel dec(0)
**********************************************************************
...
bsqreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year, quant(.25) reps (500)
outreg2 using regression_result, replace excel dec(0) 
bsqreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year, quant(.5) reps (500)
outreg2 using regression_result, append excel dec(0) 
bsqreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year, quant(.6)  reps (500)
outreg2 using regression_result, append excel dec(0)
bsqreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year, quant(.7)  reps (500)
outreg2 using regression_result, append excel dec(0)
bsqreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year, quant(.75)  reps (500)
outreg2 using regression_result, append excel dec(0)
bsqreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year, quant(.8)  reps (500)
outreg2 using regression_result, append excel dec(0)
bsqreg ylabr more2sons edad edad_fb hijo1_sexa hijo2_sexa region pareja granfb etnia_b i.year, quant(.9) reps (500)
outreg2 using regression_result, append excel dec(0)
