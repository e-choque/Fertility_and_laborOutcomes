...
*********************************************************************
 ...
 /*===============================================================*/
 * estimate e[z|x] ;
*probit samesex edad edad_fb hijo1_sexa  etnia_b hijo2_sexa edu_level [pw=perwt], r 
...
*regress job  more2sons edad edad_fb hijo1_sexa hijo2_sexa  granfb etnia_b (samesex edad edad_fb hijo1_sexa hijo2_sexa  granfb etnia_b)

probit job more2sons edad edad_fb hijo1_sexa hijo2_sexa granfb etnia_b, r 
probit more2sons samesex edad edad_fb hijo1_sexa hijo2_sexa  granfb etnia_b, r 
margins, dydx(*)
outreg2 using regression_result, replace excel dec(2)
...
*ivregress gmm job edad edad_fb hijo1_sexa   granfb etnia_b (more2sons = samesex) , vce(boot, reps(100))
